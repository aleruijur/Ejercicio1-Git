...
public class AlumnosController {
	...
	public boolean actualizar(@RequestParam("idAlumno") int idAlumno, @RequestParam("curso") String curso) {
		return service.actualizarAlumno(idAlumno, curso);
	}
	@DeleteMapping(value="Alumno/{idAlumno}",produces=MediaType.TEXT_PLAIN_VALUE)
	public boolean eliminar(@PathVariable("idAlumno") int idAlumno) {
		return service.eliminarAlumno(idAlumno);
	}
